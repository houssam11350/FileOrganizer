...
{
    public class SystemIconsManager : IDisposable
    {
        private static SystemIconsManager mSystemIconsInstance = new SystemIconsManager();

        public static SystemIconsManager GetInstance()
        {
            return mSystemIconsInstance;
        }
        ...
        private SystemIconsManager()
            : base()
        {
            _smallImageList.ColorDepth = ColorDepth.Depth16Bit;
            _smallImageList.ImageSize = SystemInformation.SmallIconSize;

            _largeImageList.ColorDepth = ColorDepth.Depth16Bit;
        ...
        public int GetIconIndex(string fileName)
        {
            ...
            else
            {
                ...
                if (shinfo.hIcon == IntPtr.Zero)
                    smallIcon = IconHandler.IconFromExtension(ext, IconSize.Small);
